...
class InsGeneralLedger(models.TransientModel):
    ...
    def _get_default_date_range(self):
        return self.env['res.company'].search([('id','=',1)]).date_range
    ...
    def build_detailed_move_lines(self, offset=0, account=0, fetch_range=FETCH_RANGE):
        ...
        currency_id = self.env['res.company'].search([('id','=',1)]).currency_id
    ...
    def process_data(self):
        ...
        account_company_domain = [('company_id','=', self.env['res.company'].search([('id','=',1)]).id)]
        ...
        for account in account_ids:
            ...
            currency = account.company_id.currency_id or self.env['res.company'].search([('id','=',1)]).currency_id
