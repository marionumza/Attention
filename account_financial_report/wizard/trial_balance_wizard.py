...
class TrialBalanceReportWizard(models.TransientModel):
    ...
    def _export(self, report_type):
        ...
        report = model.create(self._prepare_report_trial_balance())
        report.compute_data_for_report()
        # print("self.id", report.id)
        # print(self.date_from.month)
        # print(self.date_from.day)
        # if self.date_from.month==1 and self.date_from.day == 1:
        #     model._calc_initial_retain(report.id)
