...
class AccountInvoice(models.Model):
    ...
    # @api.model
    # def invoice_line_move_line_get_city(self):
    #     res = []
    #     for line in self.invoice_line_ids:
    #         move_line_dict = {
    #
    #             'city_id': line.city_id.id,
    #             'branch_id': line.region_id.id,
    #         }
    #         print("%%%%%%%%5555", move_line_dict)
    ...
    def line_get_convert(self, line, part):
        print("haytham1111", line)
        print("ggggggggggggg", line.get('branch_id'))
        res = self.env['product.product']._convert_prepared_anglosaxon_line(line, part)
        res.update({'city_id': line.get('city_id'), 'branch_id': line.get('branch_id')})
        print("res", res)
        return res
    ...
    def action_move_create(self):
        ...
        for inv in self:
            ...
            #     print("branch",move_line.branch_id)
            #     print("city",move_line.city_id)
